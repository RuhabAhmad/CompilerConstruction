...
static const char *const yytname[] =
{
  ...
  "TRUE", "FALSE", "NULLTOK", "'{'", "'}'", "','", "':'", "'['", "']'",
  "$accept", "json", "value", "object", "members", "pair", "array",
  "elements", YY_NULLPTR
};
...
#line 1106 "parser.tab.c"
  ...
  case 5: /* value: STRING  */
#line 37 "parser.y"
             { (yyval.node) = create_string((yyvsp[0].str)); }
#line 1112 "parser.tab.c"
    break;

  case 6: /* value: NUMBER  */
#line 38 "parser.y"
             { (yyval.node) = create_number((yyvsp[0].str)); }
...
#line 1170 "parser.tab.c"
  ...
  case 14: /* pair: STRING ':' value  */
#line 65 "parser.y"
                     {
        (yyval.node) = create_pair((yyvsp[-2].str), (yyvsp[0].node));
    }
...
#line 74 "parser.y"
                       {
        (yyval.node) = create_node(NODE_ARRAY);
        (yyval.node)->child = (yyvsp[-1].node)->child;
    }
